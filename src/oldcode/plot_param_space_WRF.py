...
parser.add_argument('--parameters', type=str, nargs="+", help='Parameters. The first and second parameters will be the varying parameters while the rest stays fixed.', required=True)
